...
declare function cssHelper(this: LocalsType, ...args: any[]): string;
declare const _default: import("moize").Moized<typeof cssHelper, Partial<{
    isDeepEqual: boolean;
    isPromise: boolean;
    isReact: boolean;
    ...
    maxArgs: number;
    maxSize: number;
    onCacheAdd: import("moize").OnCacheOperation<typeof cssHelper>;
    onCacheChange: import("moize").OnCacheOperation<typeof cssHelper>;
    onCacheHit: import("moize").OnCacheOperation<typeof cssHelper>;
